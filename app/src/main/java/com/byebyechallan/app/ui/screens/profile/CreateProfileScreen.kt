...
fun CreateProfileScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.loadDefaultRecipients()
    }

    LaunchedEffect(state.defaultRecipients) {
        state.defaultRecipients?.let { recipients = it }
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            PrimaryButton(
                ...
                onClick = { viewModel.createProfile(profileName, recipients) }
            )
        }
    }
}
